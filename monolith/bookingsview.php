...
<?php
     $data = read('bookings', "ID, BookingNo, POL, POD, ETD,BookingValidTill, NVO_SL, Department");
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Customer Service View</h5>
...
<div class="modal fade"  id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">View More Section</h5>
        <button type="button" class="close" onclick="closemodal()" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Customer Service table</h6>
              </div>
            </div>
  ...
  <script>
                      ...
                      function showmodel(id){
                         ...
                         var BookingValidTill = makeEditField(pointer.BookingValidTill, 'BookingValidTill');
                         var NVO_SL = makeEditField(pointer.NVO_SL, 'NVO_SL');
                         var Department = makeEditField(pointer.Department, 'Department');

                         var fields = [BookingNo, POL, POD, ETD, BookingValidTill, NVO_SL, Department];
                          myform = makeForm(fields, pointer.ID, 'models/savedata_api.php', 'post');
                      ...
                      function showbutton(rowid){
                        ...
                        function formatMsgtoUlLi(msg){
                          ...
                          jQuery.each( arr, function( key, val ) {
                              if(i%2==0){
                               myUlLiString += '<li class="list-group-item border-0 ps-0 pt-0 text-sm" style=" padding-top: 10px; background-color:#eeeeee;"><strong class="text-dark">'+key+':</strong> &nbsp; '+val+'</li>';
                              }
                              else{
