...
<?php
     $data = read('bookings', "ID, DateOfBooking , BookingNo , POL ,POD , ETD ,CustomerName , NVO_SL , ContainerCount ");
    //  print_r($data);
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Sales View table</h6>
              </div>
            </div>
...
<script>
                      ...
                      //ID, DateOfBooking , BookingNo , POL ,POD , ETD ,CustomerName , NVO_SL , ContainerCount
                      //modal code here
                      function showmodel(id){
                          var pointerid = id-1;
                          var pointer = options[pointerid];

                          var DateOfBooking = makeEditField(pointer.DateOfBooking, 'Date Of Booking');
                          var  BookingNo= makeEditField(pointer.BookingNo, 'Booking No');
                         var POL = makeEditField(pointer.POL, 'POL');
                         var POD = makeEditField(pointer.POD, 'POD');
                         var ETD = makeEditField(pointer.ETD, 'ETD');
                         var CustomerName = makeEditField(pointer.CustomerName, 'Customer Name');
                         var NVO_SL = makeEditField(pointer.NVO_SL, 'NVO or SL');
                         var ContainerCount = makeEditField(pointer.ContainerCount, 'Container Count');

                         var fields = [DateOfBooking , BookingNo , POL ,POD , ETD ,CustomerName , NVO_SL , ContainerCount];
